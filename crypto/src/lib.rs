...
pub mod tests {
    ...
    const FAST_HASH_TEST_VECTORS: &'static [TestVector] = &[
        TestVector {
            expected: &[
                0xc8, 0x8c, 0xe9, 0x78, 0x3b, 0x4f, 0x11, 0x19, 0x0d, 0x7b, 0x9c,
                0x17, 0xa6, 0x9c, 0x1c, 0x52, 0x20, 0x0f, 0x9f, 0xaa, 0xee, 0x8e,
                0x98, 0xdd, 0x07, 0xe6, 0x81, 0x11, 0x75, 0x17, 0x71, 0x39,
            ],
